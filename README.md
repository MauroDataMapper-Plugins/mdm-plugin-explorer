...
| explorer.theme.regularcolors.specificationcount      | Colour for the counter in the header bar                     | #ffe603       |
| explorer.theme.contrastcolors.page                   | Overall background page colour                               | #fff          |
| explorer.theme.contrastcolors.unsentspecification    | Colour of status tags for unsent specifications              | #008bce       |
| explorer.theme.contrastcolors.submittedspecification | Colour of status tags for submitted specifications           | #0e8f77       |
